   ...
   <script type="text/javascript">
	function getLabBills() {
	  ...
	  if(regddate.length > 0) {
		$.post("ViewLabBillsResult.jsp",{searchString: ""+regddate+"",consultant: ""+consultant+""},function(data){
		 $('#viewLabBillsResult').html(data).show();
		});
	  }else{
		$('#viewLabBillsResult').html("").show();
		alert("Select a Date to Display LabBill Info");
	  }
	}
  ...
  <body class="hd" onload="javascript:settime(); getData();">
   ...
   <div class="main">
    ...
    <tr align="center" style="height:100px;padding-top:50px;">
      <td width="350px" align="right" colspan="2">List of all Lab Bills on
      ...
      <td><input type="button" id="getData" value="Get Lab Bills" onclick="getLabBills()" /></td>
    </tr>
    <tr align="center" style="height:100px;padding-top:50px;">
      <td colspan="2">
      ...
      <td><a href="javascript:showHideFilter()">Show/Hide Filter</a></td> 
   	...
   	<div id="viewLabBillsResult" align='center' style='min-height:550px;'></div>
   </div>
  </body>
  <%}else{
