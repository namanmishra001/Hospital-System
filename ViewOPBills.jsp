   ...
   <script type="text/javascript">
	function getOpBills() {
	  ...
	  if(regddate.length > 0) {
		$.post("ViewOPBillsResult.jsp",{searchString: ""+regddate+"",consultant: ""+consultant+""},function(data){
		 $('#viewOpBillsResult').html(data).show();
		});
	  }else{
		$('#viewOpBillsResult').html("").hide();
		alert("Select a Date to Display OpBill Info");
	  }
	}
  ...
  <body class="hd" onload="javascript:settime(); getData();">
   ...
   <div class="main">
    ...
    <tr align="center" style="height:100px;padding-top:50px;">
      <td width="350px" align="right" colspan="2">List of all OP Bills on
      ...
      <td><input type="button" id="getData" value="Get OP Bills" onclick="getOpBills();" /></td>
    </tr>
    <tr align="center" style="height:100px;padding-top:50px;">
      <td colspan="2">
      <span id="filter" style="display: none; text-align: center;">
       Select Doctor/Consultant Name:
       <select name="Consultant" id="Consultant" onchange="getOpBills()">
      ...
      <td><a href="javascript:showHideFilter()">Show/Hide Filter</a></td> 
   	...
   	<div id="viewOpBillsResult" align='center' style='min-height:550px;'></div>
   </div>
  </body>
  <%}else{
