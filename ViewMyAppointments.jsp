   ...
   <script type="text/javascript">
	function getAppointments() {
	  ...
	  if(regddate.length > 0) {
		$.post("ViewMyAppointmentsResult.jsp",{regddate: ""+regddate+"",consultant: ""+consultant+""},function(data){
	...
	function changeStatus(visitId){
		$.post("ChangeVisitStatus.jsp",{visitId: ""+visitId+""},function(data){
		});
	}
   </script>
  </head>
    ...
    <tr align="center" style="height:100px;padding-top:50px;">
      <td width="350px" align="right" colspan="2">
       ...
       <input type="text" readonly="readonly" id="regddate" name="regddate" value='<%=new SimpleDateFormat("dd-MM-yyyy").format(new Date())%>' size="9" class="timer" />
   	  ...
   	  <td>
   	   <input type="button" id="getData" value="Get Appointments" onclick="getAppointments();" />
   	   <%
