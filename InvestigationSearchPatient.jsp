	 ...
	 <script type="text/javascript">
	  function lookup(inputString) {
		if(inputString.length > 0) {
		  $.post("InvestigationSearchPatientResult.jsp",{searchString: ""+inputString+""},function(data){
	  ...
	  function viewInvestigations(inputString) {
		if(inputString.length > 0) {
		  $.post("ViewInvestigations.jsp",{searchString: ""+inputString+""},function(data){
			$('#searchInvestigationResult').html(data).show();
		  });
		}else{
			$('#searchInvestigationResult').html("").show();
		}
